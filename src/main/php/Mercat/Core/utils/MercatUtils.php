...
class MercatUtils {
	...
	const MERCAT_CONCEPTO_MOVIMIENTO_ANULACIONVENTA= 5;
	const MERCAT_CONCEPTO_MOVIMIENTO_PAGO= 6;
	const MERCAT_CONCEPTO_MOVIMIENTO_DEVOLUCION= 7;
	const MERCAT_CONCEPTO_MOVIMIENTO_ACTUALIZACION= 8;
	const MERCAT_CONCEPTO_MOVIMIENTO_COMISIONVENTA= 9;
	...
	const MERCAT_CUENTA_UNICA = 1;

	const MERCAT_CAJA_DEFAULT = 1;

	const MERCAT_CLIENTE_DEFAULT = 1;

	const MERCAT_VENDEDOR_DEFAULT = 1;
	...
	const MERCAT_TIPO_PRODUCTO_DEFAULT = 21;
	const MERCAT_MARCA_PRODUCTO_DEFAULT = 24;
	...
	public static function sendMailPop($nameTo, $to, $subject, $msg, $attachs) {
		...
		/*$libsHome= MercatConfig::getInstance()->getLibsPath();
		...
		if( MercatConfig::TEST_MODE ){
			//me los envÃ­o todos a mi en test
			$to = MercatConfig::TEST_MAIL_TO;
		}
		...
		$mail->Host = MercatConfig::POP_MAIL_HOST;
		//Set the SMTP port number - likely to be 25, 465 or 587
		$mail->Port = MercatConfig::POP_MAIL_PORT;
		$mail->SMTPSecure = MercatConfig::POP_MAIL_SMTP_SECURE;
		//Whether to use SMTP authentication
		$mail->SMTPAuth = true;
		//Username to use for SMTP authentication
		$mail->Username = MercatConfig::POP_MAIL_USERNAME;
		//Password to use for SMTP authentication
		$mail->Password = MercatConfig::POP_MAIL_PASSWORD;

		//Set who the message is to be sent from
		$mail->setFrom(MercatConfig::MAIL_FROM, MercatConfig::MAIL_FROM_NAME);
		//Set an alternative reply-to address
		$mail->addReplyTo(MercatConfig::MAIL_FROM, MercatConfig::MAIL_FROM_NAME);
	...
	public static function sendMail($nameTo, $to, $subject, $msg, $attachs) {
		...
		if (MercatConfig::MAIL_ENVIO_POP)
	...
	public static function getConceptoMovimientoGasto(){
		...
		return ServiceFactory::getConceptoMovimientoService()->get( self::MERCAT_CONCEPTO_MOVIMIENTO_GASTO );
	}

	public static function getConceptoMovimientoAnulacionGasto(){

		return ServiceFactory::getConceptoMovimientoService()->get( self::MERCAT_CONCEPTO_MOVIMIENTO_ANULACIONGASTO );
	}

	public static function getConceptoMovimientoVenta(){

		return ServiceFactory::getConceptoMovimientoService()->get( self::MERCAT_CONCEPTO_MOVIMIENTO_VENTA );
	}

	public static function getConceptoMovimientoAnulacionVenta(){

		return ServiceFactory::getConceptoMovimientoService()->get( self::MERCAT_CONCEPTO_MOVIMIENTO_ANULACIONVENTA );
	}

	public static function getConceptoMovimientoPago(){

		return ServiceFactory::getConceptoMovimientoService()->get( self::MERCAT_CONCEPTO_MOVIMIENTO_PAGO);
	}

	public static function getConceptoMovimientoDevolucion(){

		return ServiceFactory::getConceptoMovimientoService()->get( self::MERCAT_CONCEPTO_MOVIMIENTO_DEVOLUCION);
	}

	public static function getConceptoMovimientoActualizacion(){

		return ServiceFactory::getConceptoMovimientoService()->get( self::MERCAT_CONCEPTO_MOVIMIENTO_ACTUALIZACION);
	}

	public static function getConceptoMovimientoComisionVenta(){

		return ServiceFactory::getConceptoMovimientoService()->get( self::MERCAT_CONCEPTO_MOVIMIENTO_COMISIONVENTA);
	}

	public static function getConceptoMovimientoAnulacionComisionVenta(){

		return ServiceFactory::getConceptoMovimientoService()->get( self::MERCAT_CONCEPTO_MOVIMIENTO_ANULACIONCOMISIONVENTA);
	}

	public static function getConceptoMovimientoPedido(){

		return ServiceFactory::getConceptoMovimientoService()->get( self::MERCAT_CONCEPTO_MOVIMIENTO_PEDIDO );
	}
	...
	public static function getCuentaUnica(){
		...
		return ServiceFactory::getCuentaService()->get( self::MERCAT_CUENTA_UNICA );
	}

	public static function getCajaDeafault(){

		return ServiceFactory::getCajaService()->get( self::MERCAT_CAJA_DEFAULT );
	}

	public static function getPrecioDolar(){

		return ServiceFactory::getParametroService()->get( self::MERCAT_ID_DOLAR );
	}

	public static function getPorcentajePrecioLista(){

		return ServiceFactory::getParametroService()->get( self::MERCAT_ID_PORCENTAJE_PRECIO_LISTA );
	}

	public static function getTipoProductoDefault(){

		return ServiceFactory::getTipoProductoService()->get( self::MERCAT_TIPO_PRODUCTO_DEFAULT );
	}

	public static function getMarcaProductoDefault(){

		return ServiceFactory::getMarcaProductoService()->get( self::MERCAT_MARCA_PRODUCTO_DEFAULT );
	}

	public static function getClienteDefault(){

		return ServiceFactory::getClienteService()->get( self::MERCAT_CLIENTE_DEFAULT );
	}
