 ...
 */
class Venta extends \Mercat\Core\model\Venta implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Mercat\\Core\\model\\Venta' . "\0" . 'fecha', '' . "\0" . 'Mercat\\Core\\model\\Venta' . "\0" . 'cliente', '' . "\0" . 'Mercat\\Core\\model\\Venta' . "\0" . 'monto', '' . "\0" . 'Mercat\\Core\\model\\Venta' . "\0" . 'montoPagado', '' . "\0" . 'Mercat\\Core\\model\\Venta' . "\0" . 'montoDebe', '' . "\0" . 'Mercat\\Core\\model\\Venta' . "\0" . 'ganancia', '' . "\0" . 'Mercat\\Core\\model\\Venta' . "\0" . 'montoDevolucion', '' . "\0" . 'Mercat\\Core\\model\\Venta' . "\0" . 'montoActualizado', '' . "\0" . 'Mercat\\Core\\model\\Venta' . "\0" . 'estado', '' . "\0" . 'Mercat\\Core\\model\\Venta' . "\0" . 'observaciones', '' . "\0" . 'Mercat\\Core\\model\\Venta' . "\0" . 'vendedor', '' . "\0" . 'Mercat\\Core\\model\\Venta' . "\0" . 'comision', '' . "\0" . 'Mercat\\Core\\model\\Venta' . "\0" . 'user', '' . "\0" . 'Mercat\\Core\\model\\Venta' . "\0" . 'detalles', '' . "\0" . 'Mercat\\Core\\model\\Venta' . "\0" . 'devoluciones'];
        }
     ...
     * {@inheritDoc}
     */
    public function addDetalle(\Mercat\Core\model\DetalleVenta $detalle)
    {
     ...
     * {@inheritDoc}
     */
    public function addDevolucion(\Mercat\Core\model\DevolucionVenta $devolucion)
    {
    ...
    public function getVendedor()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getVendedor', []);
    ...
    public function setVendedor($vendedor)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setVendedor', [$vendedor]);
