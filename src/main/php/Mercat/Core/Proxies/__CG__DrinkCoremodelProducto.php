 ...
 */
class Producto extends \Mercat\Core\model\Producto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Mercat\\Core\\model\\Producto' . "\0" . 'fecha', '' . "\0" . 'Mercat\\Core\\model\\Producto' . "\0" . 'codigo', '' . "\0" . 'Mercat\\Core\\model\\Producto' . "\0" . 'tipoProducto', '' . "\0" . 'Mercat\\Core\\model\\Producto' . "\0" . 'marcaProducto', '' . "\0" . 'Mercat\\Core\\model\\Producto' . "\0" . 'nombre', '' . "\0" . 'Mercat\\Core\\model\\Producto' . "\0" . 'descripcion', '' . "\0" . 'Mercat\\Core\\model\\Producto' . "\0" . 'iva', '' . "\0" . 'Mercat\\Core\\model\\Producto' . "\0" . 'stock', '' . "\0" . 'Mercat\\Core\\model\\Producto' . "\0" . 'stockMinimo', '' . "\0" . 'Mercat\\Core\\model\\Producto' . "\0" . 'precioLista', '' . "\0" . 'Mercat\\Core\\model\\Producto' . "\0" . 'precioEfectivo', '' . "\0" . 'Mercat\\Core\\model\\Producto' . "\0" . 'costo', '' . "\0" . 'Mercat\\Core\\model\\Producto' . "\0" . 'porcentajeGanancia', '' . "\0" . 'Mercat\\Core\\model\\Producto' . "\0" . 'porcentajeGanancia2', '' . "\0" . 'Mercat\\Core\\model\\Producto' . "\0" . 'vencimiento', '' . "\0" . 'Mercat\\Core\\model\\Producto' . "\0" . 'cantidad'];
        }
    ...
    public function getPorcentajeGanancia2()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPorcentajeGanancia2', []);

        return parent::getPorcentajeGanancia2();
    }
    ...
    public function setPorcentajeGanancia2($porcentajeGanancia2)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPorcentajeGanancia2', [$porcentajeGanancia2]);

        return parent::setPorcentajeGanancia2($porcentajeGanancia2);
    }
