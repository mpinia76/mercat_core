...
namespace mercat\Core\Proxies\__CG__\Cose\Security\model;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Permission extends \Cose\Security\model\Permission implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Cose\\Security\\model\\Permission' . "\0" . 'name', '' . "\0" . 'Cose\\Security\\model\\Permission' . "\0" . 'description', '' . "\0" . 'Cose\\Security\\model\\Permission' . "\0" . 'parent'];
        }
