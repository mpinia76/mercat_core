 ...
 */
class Pago extends \Mercat\Core\model\Pago implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Mercat\\Core\\model\\Pago' . "\0" . 'fechaHora', '' . "\0" . 'Mercat\\Core\\model\\Pago' . "\0" . 'cliente', '' . "\0" . 'Mercat\\Core\\model\\Pago' . "\0" . 'monto', '' . "\0" . 'Mercat\\Core\\model\\Pago' . "\0" . 'estado', '' . "\0" . 'Mercat\\Core\\model\\Pago' . "\0" . 'observaciones', '' . "\0" . 'Mercat\\Core\\model\\Pago' . "\0" . 'user'];
        }
