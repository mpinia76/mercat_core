 ...
 */
class MarcaProducto extends \Mercat\Core\model\MarcaProducto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Mercat\\Core\\model\\MarcaProducto' . "\0" . 'nombre'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MarcaProducto $proxy) {
