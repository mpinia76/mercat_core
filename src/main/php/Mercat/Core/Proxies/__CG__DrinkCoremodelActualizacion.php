 ...
 */
class Actualizacion extends \Mercat\Core\model\Actualizacion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Mercat\\Core\\model\\Actualizacion' . "\0" . 'fechaHora', '' . "\0" . 'Mercat\\Core\\model\\Actualizacion' . "\0" . 'cliente', '' . "\0" . 'Mercat\\Core\\model\\Actualizacion' . "\0" . 'monto', '' . "\0" . 'Mercat\\Core\\model\\Actualizacion' . "\0" . 'observaciones', '' . "\0" . 'Mercat\\Core\\model\\Actualizacion' . "\0" . 'user'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Actualizacion $proxy) {
