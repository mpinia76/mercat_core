...
class MercatConfig {
	...
	private $appPathCore = "D:/Documents/Mis Webs/mercat_core";

	const PROXIES_NAMESPACE="mercat\\Core\\Proxies";
	const PROXIES_PATH=  "/Proxies";

	const TEST_MODE = true;
	const MAIL_FROM_NAME = "Your Mercat";
	const MAIL_FROM = "ciprianotedesco@gmail.com";
